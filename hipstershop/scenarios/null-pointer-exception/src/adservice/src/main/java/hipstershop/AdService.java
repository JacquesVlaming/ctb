...
public final class AdService {
  ...
  private static class AdServiceImpl extends hipstershop.AdServiceGrpc.AdServiceImplBase {
    ...
    public void getAds(AdRequest req, StreamObserver<AdResponse> responseObserver) {
      ...
      ProtocolStringList contextKeys = req.getContextKeysList();
      ...
      try (final Scope scope = transaction.activate(); final Scope spanScope = span.activate()) {
        ...
        logger.info("received ad request (context_words=" + contextKeys + ")");
        span.setName("getAdsByCategory");
        ArrayListMultimap<String, Ad> new_adds = service.getAdsByCategory(contextKeys);
